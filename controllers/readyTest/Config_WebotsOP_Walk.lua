...
walk.qRArm={110*math.pi/180,-2*math.pi/180,-40*math.pi/180};
walk.qLArmKick={90*math.pi/180,15*math.pi/180,-40*math.pi/180};
walk.qRArmKick={90*math.pi/180,-15*math.pi/180,-40*math.pi/180};
...
walk.ankleMod = {-1*2*math.pi/180,0*2*math.pi/180};
